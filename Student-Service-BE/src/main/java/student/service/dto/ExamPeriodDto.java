...
public class ExamPeriodDto implements Serializable {
	...
	private static final long serialVersionUID = 1223141821949287414L;
	...
	public ExamPeriodDto(Long id, String name, Date examPeriodFrom, Date examPeriodTo) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "ExamPeriodDto [id=" + id + ", name=" + name + ", examPeriodFrom=" + examPeriodFrom + ", examPeriodTo="
				+ examPeriodTo + "]";
	}
